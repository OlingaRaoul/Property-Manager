        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '2.25rem' }}>
                    ...
                    <h2 style={{ fontSize: '1.8rem', fontWeight: '800', letterSpacing: '-0.5px', marginBottom: '0.4rem', fontFamily: 'Sora' }}>Create Account</h2>
                    <p style={{ color: '#94A3B8', fontSize: '0.88rem', fontWeight: '500' }}>Join Property Manager Pro today</p>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                    {/* Full Name Input */}
                    <div>
                        <label style={{ display: 'block', fontSize: '0.78rem', color: '#94A3B8', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '0.4rem' }}>Full Name</label>
                    ...
                    {/* Password Input */}
                    <div>
                        <label style={{ display: 'block', fontSize: '0.78rem', color: '#94A3B8', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '0.4rem' }}>Password (min 6 chars)</label>
                        <div style={{ position: 'relative' }}>
                ...
                <div style={{ textAlign: 'center', marginTop: '1.75rem', fontSize: '0.85rem', color: '#94A3B8' }}>
                    ...
                    <Link to="/login" style={{ color: '#2D60FF', fontWeight: '700', textDecoration: 'none', transition: 'color 0.2s' }}
